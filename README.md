...
```
Daear-Consulting/
├── earth-intelligence-toolkit    # shared library — data access, indicators, cube, governance, viz
├── wildfire-landscape-intelligence   # ARID centerpiece — fully built, 4/4 modules
├── soil-watershed-intelligence       # SHIELD centerpiece — module 3 built, 1/2/4 scaffolded
├── tribal-wildfire-intelligence      # data sovereignty differentiator — module 4 built, 1/2/3 scaffolded
└── climate-resilience-indicators     # synthesis/atlas layer — module 3 built, 1/2/4 scaffolded
```

## What this is

A working demonstration that Daear's wildfire, soil-watershed, and data
sovereignty work are facets of one platform, not three separate products.
All four downstream repos share one library (`earth-intelligence-toolkit`)
and anchor on one real place: the **Cache la Poudre watershed above Fort
...
**Fully built:** `wildfire-landscape-intelligence` (all 4 modules — this is
the ARID centerpiece and the most complete repo).
